...
public class PhieuMuonChiTietDao extends LibrarianDAO<PhieuMuonChiTiet, Long> {
    ...
    private final String SELECT_ALL_SQL = "SELECT PhieuMuon, Sach, NguoiTiepNhan, NgayTra, TrangThai FROM phieu_muon_chi_tiet";
    ...
    protected List<PhieuMuonChiTiet> selectBySql(String sql, Object... args) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                pmct.setNguoiXuLy(rs.getString("NguoiTiepNhan"));
